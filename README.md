...
* 🌌 **[Wallep](https://github.com/krtvysinghh/Wallep)** — Native 4K live wallpaper engine for macOS built with Swift, AppKit & AVFoundation.
* 🔐 **[Orvpass](https://github.com/krtvysinghh/Orvpass)** — Zero-knowledge, modern cryptographic password manager built in Rust.
* 🧠 **[Esprit](https://github.com/krtvysinghh/Esprit)** — Modular AI workspace & filesystem intelligence engine in Rust.
* ⚡ **Stack Focus:** Rust, Low-level Systems, macOS Internal APIs, Distributed Tooling & Applied Cryptography.
